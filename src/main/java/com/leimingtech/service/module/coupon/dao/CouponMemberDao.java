...
public interface CouponMemberDao {
	 ...
	 * @return
	 */
	public List<CouponMember> findCouponsByConditions(String memberId,String storeIds, String goodsClassIds);
	/**
	 * 根据条件获取会员优惠券
	 * @param memberId
	 * @param storeIds
	 ...
	 * @return
	 */
	List<CouponMember> findCouponMemberByConditions(String memberId,
