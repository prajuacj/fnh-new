...
public interface GoodsSearchMapper {
	 ...
	 * 获得当前关键词所对应的可选规格
	 */
	List<SpecVo> getSpecListByKeyword(@Param(value = "keyword") String keyword, @Param(value = "dbName") String dbName);
	 ...
	 * 获得当前关键词所对应的可选品牌
	 */
	List<Brand> getBrandListByKeyword(@Param(value="keyword") String keyword, @Param(value="dbName") String dbName);
