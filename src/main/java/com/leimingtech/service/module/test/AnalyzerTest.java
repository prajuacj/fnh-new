package com.leimingtech.service.module.test;
...
public class AnalyzerTest {
	...
	public static void analyzerTestDo(String testStr){
		Analyzer analyzer = new SimpleAnalyzer("/Users/chen/B2B2C/trunk/leimingtech-service/src/main/resources/data/words.dic");
		try {
