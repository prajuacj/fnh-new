...
public interface DaddressDao {
	 ...
	 * @param addressId
	 */
	void deleteDaddress(String addressId);
	 ...
	 * @return
	 */
	Daddress findDaddressById(String addressId);
	 ...
	 * @return
	 */
	List<Daddress> findDaddressByStoreId(String storeId);
	 ...
	 * @return
	 */
	int findDefaultCountByStoreId(String storeId);
}
