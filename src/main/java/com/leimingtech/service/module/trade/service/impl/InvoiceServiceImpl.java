 ...
 * 发票service
 * 
 * @author cgl 2015年08月14日16:14:55
 */
@Service
public class InvoiceServiceImpl implements InvoiceService {
	...
	/**
	 * 修改 描述:这个方法修改的是普通发票的信息 invTitle:发票抬头的数组 invContent:发票内容
	 * invTitleDef:默认的发票抬头,应是invTitle数组里面的某一个值
	 */
	@Override
	public void updateCommonInv(String[] invTitles, String invContent, String memberId) {
	...
	/**
	 * 修改 描述:这个方法修改的是增值税发票的信息
	 */
	public Invoice updateVATInv(Invoice invoice, String memberId) {
	 ...
	 */
	@Override
	public void updateDef(String invId) {
		Invoice invoice = new Invoice();
	...
	public Pager findPageList(Pager pager) {
		// TODO Auto-generated method stub
		List<Invoice> list = invoiceDao.findPageList(pager);
	 ...
	 */
	@Override
	public Invoice saveInvoiceTitle(String memberId, String title) {
		// 将用户发票下所有发票去掉默认
	 ...
	 * @param memberId
	 */
	public void deleteOrtherDef(String memberId) {
		invoiceDao.updateDef(memberId);
	}
	 ...
	 * @return
	 */
	public Invoice saveInvoiceForApi(String memberId, String invTitle, String invContent, String invState) {
		// 将用户发票下所有发票去掉默认
		invoiceDao.updateDef(memberId);
		// 新建发票信息
		Invoice invoice = new Invoice();
