 ...
 * @类名称：TransportServiceImpl @类描述： 运费模板
 * @创建人：shining
 * @创建时间：2014年12月7日 下午10:46:32
 * @修改人：shining
 * @修改时间：2014年12月7日 下午10:46:32 @修改备注：
 * @version
 * 
 */
@Service
public class TransportServiceImpl implements TransportService {
	 ...
	 */
	@Override
	public void save(String storeId, String title, String tranStr) {
		// 运费模板
	...
	@Override
	public void update(String transportId, String storeId, String title, String tranStr) {
		// 运费模板
		Transport transport = new Transport();
	...
	private void saveTransportExtend(String tranStr, String title, String transportId) {
	...
	/**
	 * 
	 * @Title: 修改默认运费模板 setDefaultTransport
	 */
	@Override
	public void updateDefaultTransport(String storeId, String transportId) {
	...
	/**
	 * 通过transportId,二级地区id(市级id),商品数量 得到对应的运费模板的运费价格
	 * 如果二级地区id(cityId)设为null,那么返回的价格是默认的运费模板(全国)的价格标准
	 */
	@Override
	public BigDecimal getFreightForTransport(String transportId, String type, String cityId, int goodsCount) {
		return getTotalFreight(transportId, type, cityId, goodsCount);
	}

	/**
	 * 通过storeId,送货类型(平邮py 快递kd EMS es),二级地区id(市级id),商品数量 得到对应的运费模板的运费价格
	 * 如果二级地区id(cityId)设为null,那么返回的价格是默认的运费模板(全国)的价格标准
	 */
	@Override
	public BigDecimal getFreightForStore(String storeId, String type, String cityId, int goodsCount) {
	 ...
	 * 得到运费
	 */
	private BigDecimal getTotalFreight(String transportId, String type, String cityId, int goodsCount) {
